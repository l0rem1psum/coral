...
func InitializeGeneric1In0OutSyncMultiProcessor[IO Generic1In0OutSyncProcessorIO[I, In], I, In any, P Generic1In0OutSyncProcessor[In]](processors []P, opts ...Option) func(inputs <-chan []I) (*Controller, []error) {
	...
	return func(inputs <-chan []I) (*Controller, []error) {
		...
		outputChs := make([]chan struct{}, len(processors))
		...
		for i, processor := range processors {
			go singleGeneric1In0OutSyncProcessorLoop[IO](
				processor,
				initErrChs[i],
				startChs[i],
				stopAfterInits[i],
...
func singleGeneric1In0OutSyncProcessorLoop[IO Generic1In0OutSyncProcessorIO[I, In], I, In any, P Generic1In0OutSyncProcessor[In]](
	processor P,
